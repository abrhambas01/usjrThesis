...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gmaps__ = __webpack_require__("./node_modules/gmaps/gmaps.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gmaps___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_gmaps__);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
	...
	map = new __WEBPACK_IMPORTED_MODULE_1_gmaps___default.a({
		el: '#map',
		lat: -12.043333,
		lng: -77.028333,
		zoom: 19,
	...
	__WEBPACK_IMPORTED_MODULE_1_gmaps___default.a.geolocate({
		success: function success(position) {
			...
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.calculateRoute').on('click', function () {
			...
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.showMyLocation').on('click', function () {
				map.panTo({
					lat: position.coords.latitude,
					lng: position.coords.longitude
				});
		...
		always: function always(position) {
...
function getDeliveries(url) {
	__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON(url, function (data) {
...
function calculateRoute(position) {
	...
	map.drawRoute({
		...
		destination: [10.30431500, 123.89035500],
		travelMode: 'driving',
		strokeColor: '#0064ff',
		strokeOpacity: 0.6,
		strokeWeight: 6
