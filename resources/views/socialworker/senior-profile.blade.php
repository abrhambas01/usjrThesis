...
@include('socialworker.partials.senior-profile')
@endsection
@section('modal')
@endsection
@section('footer')
...
<script type="text/javascript" src="{{ URL::to('assets/dashboard/dist/js/form-picker-data.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::to('assets/dashboard/dist/js/modal-data.js') }}"></script>
<script type="text/javascript" src="{{ URL::to('assets/dashboard/dist/js/app.js') }}"></script>
@endsection
