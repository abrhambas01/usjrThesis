...
<body>
             ...
             <div class="hero bg-black-op">
              <div class="hero-inner">
               ...
               <a class="btn btn-hero btn-noborder btn-rounded btn-alt-primary mb-10 invisible" data-toggle="appear" href="#">
                 <i class="si si-rocket mr-5"></i> How it Works ? 
               </a>
             </div>
           </div>
         </div>
  ...
  <div class="row no-gutters pull-b text-center overflow-hidden">
   <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
    <a class="options-container" href="be_pages_dashboard.html">
     <img class="img-fluid options-item" src="assets/img/various/landing-promo-layout-backend.png" srcset="assets/img/various/landing-promo-layout-backend@2x.png 2x" alt="Backend Promo">
...
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <a class="options-container" href="bd_dashboard.html">
   <img class="img-fluid options-item" src="assets/img/various/landing-promo-layout-boxed-backend.png" srcset="assets/img/various/landing-promo-layout-boxed-backend@2x.png 2x" alt="Boxed Backend Promo">
   <div class="options-overlay bg-white">
    <div class="options-overlay-content">
     <h3 class="h5 font-w700 text-uppercase mb-5">
...
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <a class="options-container" href="be_layout_api.html">
   <img class="img-fluid options-item" src="assets/img/various/landing-promo-layout-api.png" srcset="assets/img/various/landing-promo-layout-api@2x.png 2x" alt="Layout API Promo">
   <div class="options-overlay bg-white">
    <div class="options-overlay-content">
     <h3 class="h5 font-w700 text-uppercase mb-5">
...
<div class="row no-gutters pull-b text-center overflow-hidden">
 <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <a class="options-container" href="be_ui_grid.html">
   <img class="img-fluid options-item" src="assets/img/various/landing-promo-bootstrap4-grid.png" srcset="assets/img/various/landing-promo-bootstrap4-grid@2x.png 2x" alt="Bootstrap 4 Grid Promo">
...
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <a class="options-container" href="be_ui_typography.html">
   <img class="img-fluid options-item" src="assets/img/various/landing-promo-bootstrap4-typography.png" srcset="assets/img/various/landing-promo-bootstrap4-typography@2x.png 2x" alt="Bootstrap 4 Typography Promo">
   <div class="options-overlay bg-body-light">
    <div class="options-overlay-content">
     <h3 class="h5 font-w700 text-uppercase mb-5">
      Explore
...
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <a class="options-container" href="be_ui_buttons.html">
   <img class="img-fluid options-item" src="assets/img/various/landing-promo-bootstrap4-buttons.png" srcset="assets/img/various/landing-promo-bootstrap4-buttons@2x.png 2x" alt="Bootstrap 4 Buttons Promo">
   <div class="options-overlay bg-body-light">
    <div class="options-overlay-content">
     <h3 class="h5 font-w700 text-uppercase mb-5">
      Explore
...
<div class="row no-gutters justify-content-center pull-b text-center overflow-hidden">
 <div class="col-sm-6 invisible" data-toggle="appear" data-class="animated zoomIn">
  <img class="img-fluid" src="assets/img/various/landing-promo-smart-tools.png" srcset="assets/img/various/landing-promo-smart-tools@2x.png 2x" alt="Smart Tools Promo">
</div>
</div>
</div>
</div>
...
<div class="row no-gutters pull-b text-center overflow-hidden">
 <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
  <img class="img-fluid" src="assets/img/various/landing-promo-developer-minded-php.png" srcset="assets/img/various/landing-promo-developer-minded-php@2x.png 2x" alt="Developer Minded PHP Promo">
</div>
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
  <img class="img-fluid" src="assets/img/various/landing-promo-developer-minded-docs.png" srcset="assets/img/various/landing-promo-developer-minded-docs@2x.png 2x" alt="Developer Minded Docs Promo">
</div>
<div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
  <img class="img-fluid" src="assets/img/various/landing-promo-developer-minded-html.png" srcset="assets/img/various/landing-promo-developer-minded-html@2x.png 2x" alt="Developer Minded HTML Promo">
</div>
</div>
</div>
</div>
