...
<div class="form-group row">
	<div class="col-md-9">
		<div class="form-material">
			<input type="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" id="passWord" name="password" placeholder="Please enter your password">
	...
	<div class="col-md-9">
		<div class="form-material">
			...
			<select name="barangay_id" id="barangay_id" class="form-control" > 
				<option value="">Choose a barangay for social workers..</option>
