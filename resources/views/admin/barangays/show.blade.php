...
@section('title', 'Barangay Profile')
...
<main id="main-container">
	<!-- Page Content -->
	<div class="content">
		<h2 class="content-heading">Barangay Profile : <small>{{ $barangay->name }} </small></h2>
		<div class="block">
			<!-- Navigation -->
				...
				<div class="row py-20">
					<div class="col-sm-6 invisible" data-toggle="appear">
						...
						<div class="js-slider slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="true" data-arrows="true">
							...
							<div>
								<img class="img-fluid" width="350" height="350" src="{{ asset('storage/barangay_halls/'.$barangay->barangay_hall_picture) }}" alt="Project Promo 1">
							</div>
						...
						<table class="table table-striped table-borderless mt-20">
							<tbody>
								<tr>
									<td class="font-w600">Monthly Budget</td>
									<td>{{ $barangay->name }} </td>
								</tr>
					...
					<div class="col-sm-6 nice-copy">
						<!-- Project Description -->
						<h3 class="mb-10">Barangay Profile</h3>
						<p>Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.</p>
						<h3 class="mt-20 mb-10">Barangay Vision Mission</h3>
						<p>Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.</p>
						<p>Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.</p>
