    <div class="row gutters-tiny invisible" data-toggle="appear">
        ...
        @include('admin.partials.top-widgets')
    ...
    <div class="row row-deck gutters-tiny invisible" data-toggle="appear">
        <!-- Row #2 -->
        <div class="col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="http://www.lifehack.org/611110/why-work-life-balance-is-a-curse-and-what-a-realistic-balance-really-is?ref=header-menu-dropdown-essential-read-cornerstone-productivity" style="background-image: url( {{ asset('assets/img/photos/photo14@2x.jpg') }} );">
        ...
        <div class="col-sm-6 col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="http://www.lifehack.org/385894/how-to-be-happy-12-things-you-should-do-today" style="background-image: url( {{ asset('assets/img/photos/photo24@2x.jpg') }} );">
        ...
        <div class="col-sm-6 col-xl-4">
            <a class="block block-transparent bg-image d-flex align-items-stretch" href="http://www.lifehack.org/610186/how-to-give-a-presentation-that-can-impress-your-audience?ref=header-menu-dropdown-essential-read-cornerstone-productivity" style="background-image: url( {{ asset('assets/img/photos/photo10@2x.jpg') }} );">
    ...
    <div class="row gutters-tiny invisible" data-toggle="appear">
        ...
        <div class="col-xl-8 d-flex align-items-stretch">
            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url( {{ asset('assets/img/photos/photo34@2x.jpg') }} ) ;">
                ...
                <div class="block-content block-content-full">
                    <div class="py-15 px-20 clearfix border-black-op-b">
                        ...
                        <div class="float-right mt-15 d-none d-sm-block">
                            <i class="si si-pointer fa-2x text-success"></i>
                        </div>
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-success-light">Deliveries for Today</div>
                    </div>
                    <div class="py-15 px-20 clearfix border-black-op-b">
                        <div class="float-right mt-15 d-none d-sm-block">
                            <i class="si si-wallet fa-2x text-danger"></i>
                        </div>
                        <div class="font-size-h3 font-w600 text-danger">PHP <span data-toggle="countTo" data-speed="1000" data-to="{{ $totalMoney }}">0</span></div>
                        <div class="font-size-sm font-w600 text-uppercase text-danger-light">Total Money Acquired</div>
                    </div>
                    <div class="py-15 px-20 clearfix border-black-op-b">
                        <div class="float-right mt-15 d-none d-sm-block">
