 function controlButtons(){ 
      ...
      var controlMarkerUI = document.createElement('controlMyLocation');
      
      controlMarkerUI.style.cursor = 'pointer';
      controlMarkerUI.style.backgroundImage = "url(http://localhost/dist/my_location_white.png)";
      ...
      controlTrashUI.style.backgroundImage = "url(.png)";
