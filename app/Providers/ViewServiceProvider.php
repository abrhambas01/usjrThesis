...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('partials.mobile.courier_links',function($view){
            $parcelsToPickUp = 3  ;
            ...
            $view->with('parcelsToPickUp',$parcelsToPickUp) ; 
            $view->with('todaysDeliveries',$todaysDeliveries) ; 
            $view->with('pendingDeliveries',$pendingDeliveries) ; 
